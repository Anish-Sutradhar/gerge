...
public class LowerScore2 extends Scoreboard
{
  ...
  /**
    ...
    */
  public LowerScore2(JFrame f, Die d)
  {
    super(f, d);
    ...
    // board.add(new TextField("Add total of all dice"));
   board.add(new TextField("")); 
    board.add(new TextField("")); 
    ...
    // board.add(new TextField("Score 25"));        
    board.add(new TextField(""));
    board.add(new TextField(""));        
    ...
    // board.add(new TextField("Score 30"));   
    board.add(new TextField(""));  
    board.add(new TextField(""));  
    ...
    // board.add(new TextField("Score 40"));        
    board.add(new TextField(""));  
    board.add(new TextField(""));        
    ...
    // board.add(new TextField("Score 50"));    
    board.add(new TextField(""));  
    board.add(new TextField(""));        
    ...
    //board.add(new JTextField("JJJ"), BorderLayout.NORTH);
    ...
    keypanel.setBounds(510, 450, 490, 260);
